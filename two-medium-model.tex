...
\subsection{Core Ontology: Two Interacting Media}\label{1-core-ontology-two-interacting-media}
...
\subsection{Matter as Standing Waves in the LCM}\label{2-matter-as-standing-waves-in-the-lcm}
...
\subsection{Interactions: How Forces Arise from the Two Media}\label{3-interactions-how-forces-arise-from-the-two-media}
...
\subsection{Cosmology in an Infinite Medium}\label{4-cosmology-in-an-infinite-medium}
...
\subsection{Relativity}\label{5-relativity}
...
\subsection{The Quantum Realm}\label{6-the-quantum-realm}
...
\subsection{Two Coupled Energy Reservoirs}\label{1-two-coupled-energy-reservoirs}
...
\subsection{Dense LCM Regions: Where the GCM Loses Energy}\label{2-dense-lcm-regions-where-the-gcm-loses-energy}
...
\subsection{The Problem With an Infinite Universe}\label{3-the-problem-with-an-infinite-universe}
...
\subsection{Voids: Where the Flux Runs Thin}\label{4-voids-where-the-flux-runs-thin}
...
\subsection{The Role of Photons: A Gentle, Forward-Coherent Transfer}\label{5-the-role-of-photons-a-gentle-forward-coherent-transfer}
...
\subsection{Voids as the Universe's Reset Mechanisms}\label{6-voids-as-the-universes-reset-mechanisms}
...
\subsection{A Future Predictive Handle}\label{7-a-future-predictive-handle}
...
\subsection{The Starting Point: Olbers' Paradox in an Infinite Universe}\label{1-the-starting-point-olbers-paradox-in-an-infinite-universe}
...
\subsection{Light Traveling Through Voids: A Slow Energy Drift}\label{2-light-traveling-through-voids-a-slow-energy-drift}
...
\subsection{Applying This Mechanism to an Infinite Universe}\label{3-applying-this-mechanism-to-an-infinite-universe}
...
\subsection{Where Does the Lost Energy Go?}\label{4-where-does-the-lost-energy-go}
...
\subsection{The CMB as the Equilibrium Temperature of Voids}\label{5-the-cmb-as-the-equilibrium-temperature-of-voids}
...
\subsection{A Universe Maintained by Voids}\label{6-a-universe-maintained-by-voids}
...
\subsection{The Clean Aesthetic of the 2MM Solution}\label{7-the-clean-aesthetic-of-the-2mm-solution}
