...
\section{Two Medium Model (2MM)}\label{two-medium-model-2mm}

The Two-Medium Model begins with the assumption that the
\textbf{observable physical universe} is shaped by the interaction of
two substrates: a wave-supporting \textbf{Light-Carrying Medium} (LCM)
and a momentum-carrying \textbf{Gravity-Carrying Medium} (GCM). From the
interplay of these media arise the behaviors we interpret as forces, as
well as the stable standing-wave structures we call matter. In this
framework, the familiar ``fundamental forces'' and the basic
architecture of particles are not independent ingredients but
\textbf{derived consequences} of how the two media influence one
another.
...
\tightlist
\item
  \hyperref[preface]{Preface}
\item
  \hyperref[introduction]{Introduction}
\item
  \hyperref[predictions]{Predictions}
\item
  \hyperref[methodology-and-acknowledgements]{Methodology and Acknowledgements}
\item
  \hyperref[1-core-ontology-two-interacting-media]{1. Core Ontology: Two Interacting Media}
\item
  \hyperref[2-matter-as-standing-waves-in-the-lcm]{2. Matter as Standing Waves in the LCM}
\item
  \hyperref[3-interactions-how-forces-arise-from-the-two-media]{3. Interactions: How Forces Arise from the Two Media}
\item
  \hyperref[4-cosmology-in-an-infinite-medium]{4. Cosmology in an Infinite Medium}
\item
  \hyperref[5-relativity]{5. Relativity}
\item
  \hyperref[6-the-quantum-realm]{6. The Quantum Realm}
\end{itemize}
...
\tightlist
\item
  \href{https://github.com/ktonon/two-medium-model/blob/main/earth-and-solar-system.md}{Hydrogen creation inside planets and moons}
\item
...
\item
  \textbf{\href{https://github.com/ktonon/two-medium-model/blob/main/earth-and-solar-system.md}{Hydrogen creation inside planets and moons}} (and liquid water worlds should be abundant)
\item
...
\section{Methodology and Acknowledgements}\label{methodology-and-acknowledgements}
...
\subsection{1. Core Ontology: Two Interacting Media}\label{1-core-ontology-two-interacting-media}
...
\subsubsection{1.1 The LCM: A Medium for Waves and Matter}\label{11-the-lcm-a-medium-for-waves-and-matter}
...
\subsubsection{1.2 The GCM: A Fast Flux That Generates Forces}\label{12-the-gcm-a-fast-flux-that-generates-forces}
...
In this ontology, the GCM provides the \textbf{momentum-transfer component} of all physical interactions, while the LCM provides the
...
\subsubsection{1.3 Very Different Scales: Why Two Media Can Coexist}\label{13-very-different-scales-why-two-media-can-coexist}
...
taken to be \textbf{far smaller than any length scale we can currently probe}---effectively much smaller than the Planck length for practical
...
\subsection{2. Matter as Standing Waves in the LCM}\label{2-matter-as-standing-waves-in-the-lcm}
...
\subsubsection{2.1 Pair Production as a GCM-Induced Collapse}\label{21-pair-production-as-a-gcm-induced-collapse}
...
\subsubsection{2.2 Frequency, Compression, and the Threshold for Collapse}\label{22-frequency-compression-and-the-threshold-for-collapse}
...
\subsubsection{2.3 Dual-Mode Helical Standing Waves: The Structure of Matter}\label{23-dual-mode-helical-standing-waves-the-structure-of-matter}
...
\subsubsection{2.4 The Origin of LCM Compression Fields}\label{24-the-origin-of-lcm-compression-fields}
...
\subsubsection{2.5 The Proton: Why the Lag-Mode Collapses in Dense LCM}\label{25-the-proton-why-the-lag-mode-collapses-in-dense-lcm}
...
\subsubsection{2.6 Why the Proton Remains Compressed in Low-Density LCM}\label{26-why-the-proton-remains-compressed-in-low-density-lcm}
...
\subsubsection{2.7 The Neutron: A Paired Standing-Wave Structure}\label{27-the-neutron-a-paired-standing-wave-structure}
...
\subsection{3. Interactions: How Forces Arise from the Two Media}\label{3-interactions-how-forces-arise-from-the-two-media}
...
\subsubsection{3.1 Electrostatic Forces: Compression Geometry and GCM Support}\label{31-electrostatic-forces-compression-geometry-and-gcm-support}
...
\subsubsection{3.2 Magnetic Forces: Torsion, Motion, and Collective Alignment}\label{32-magnetic-forces-torsion-motion-and-collective-alignment}
...
\subsubsection{3.3 Nuclear Structure: Why Only Proton--Neutron Pairs Bind}\label{33-nuclear-structure-why-only-protonneutron-pairs-bind}
...
\subsubsection{3.4 Gravity: Long-Range GCM Shadowing and the Resolution of the Heat Crisis}\label{34-gravity-long-range-gcm-shadowing-and-the-resolution-of-the-heat-crisis}
...
\subsection{4. Cosmology in an Infinite Medium}\label{4-cosmology-in-an-infinite-medium}
...
\subsubsection{4.1 Neutron Stars: Extreme Compression Without Matter Destruction}\label{41-neutron-stars-extreme-compression-without-matter-destruction}
...
\subsubsection{4.2 AGN Cores: Neutron Destruction and Charge-Conserving Recycling}\label{42-agn-cores-neutron-destruction-and-charge-conserving-recycling}
...
\subsubsection{4.3 Quasars as Newly Formed Matter in the Two-Medium Model}\label{43-quasars-as-newly-formed-matter-in-the-two-medium-model}
...
\subsubsection{4.4 What about Cosmological Redshift and the CMB?}\label{44-what-about-cosmological-redshift-and-the-cmb}
...
\subsection{5. Relativity}\label{5-relativity}
...
\subsubsection{5.1 Space-Time is Real}\label{51-space-time-is-real}
...
\subsubsection{5.2 Why Motion Through the LCM Causes Length Contraction}\label{52-why-motion-through-the-lcm-causes-length-contraction}
...
\subsubsection{5.3 Mutual Causation in the Two Media}\label{53-mutual-causation-in-the-two-media}
...
\subsubsection{5.4 Absolute Time, the GCM, and Faster-Than-Light Transmission}\label{54-absolute-time-the-gcm-and-faster-than-light-transmission}
...
\paragraph{Implication for SETI}\label{implication-for-seti}
...
\subsubsection{5.5 Oumuamua as an Illustration of GCM Shielding (Speculative)}\label{55-oumuamua-as-an-illustration-of-gcm-shielding-speculative}
...
\subsection{6. The Quantum Realm}\label{6-the-quantum-realm}
...
\subsubsection{6.1 Why ``quantum weirdness'' shows up}\label{61-why-quantum-weirdness-shows-up}
...
\subsubsection{6.2 Why this is not the whole story}\label{62-why-this-is-not-the-whole-story}
...
\subsubsection{6.3 The Locality Problem and Photon Collapse}\label{63-the-locality-problem-and-photon-collapse}
...
\paragraph{Setting the Stage: The GCM Shapes the Terrain}\label{setting-the-stage-the-gcm-shapes-the-terrain}
...
\paragraph{The Photon Enters the Landscape}\label{the-photon-enters-the-landscape}
...
\paragraph{Capture Zones and Collapse}\label{capture-zones-and-collapse}
...
\paragraph{Why Collapse Looks Instantaneous}\label{why-collapse-looks-instantaneous}
...
\subsubsection{6.4 How 2MM Demystifies Quantum Behavior}\label{64-how-2mm-demystifies-quantum-behavior}
...
\subsection{7. Strengths, Weaknesses, and Open Questions}\label{7-strengths-weaknesses-and-open-questions}

\subsection{8. Purpose and Scope}\label{8-purpose-and-scope}

\section{Earth and the Solar System}\label{earth-and-the-solar-system}

What follows is an application of the Two-Medium Model (2MM) to Earth
and the Solar System as a whole. If you are new to the framework, the
top-level \href{https://github.com/ktonon/two-medium-model/blob/main/README.md}{README} provides a introduction to its core
ideas.

\begin{itemize}
\tightlist
\item
  \hyperref[a-coherent-interior-how-2mm-reinterprets-the-earth-from-the-inside-out]{A   Coherent Interior: How 2MM Reinterprets the Earth From the Inside Out}
\item
  \hyperref[a-solar-system-reinterpreted-through-2mm]{A Solar System   Reinterpreted Through 2MM}
\item
  \hyperref[earth-and-venus-divergent-paths-in-a-growing-planet-framework]{Earth   and Venus: Divergent Paths in a Growing-Planet Framework}
\item
  \hyperref[water-as-the-signature-of-planetary-maturity-in-2mm]{Water   as the Signature of Planetary Maturity in 2MM}
\item
  \hyperref[related-works]{Related Works}
\end{itemize}

\subsection{A Coherent Interior: How 2MM Reinterprets the Earth From the Inside Out}\label{a-coherent-interior-how-2mm-reinterprets-the-earth-from-the-inside-out}
...
\subsubsection{A dynamical interior shaped by a universal energy flux}\label{a-dynamical-interior-shaped-by-a-universal-energy-flux}
...
\subsubsection{A confined, liquid plasma capable of self-organizing structures}\label{a-confined-liquid-plasma-capable-of-self-organizing-structures}
...
\subsubsection{Lag and lead modes: structure shaped by density}\label{lag-and-lead-modes-structure-shaped-by-density}
...
\subsubsection{Hydrogen: a bridge between deep physics and surface evolution}\label{hydrogen-a-bridge-between-deep-physics-and-surface-evolution}
...
\subsubsection{What emerges}\label{what-emerges}
...
\subsection{A Solar System Reinterpreted Through 2MM}\label{a-solar-system-reinterpreted-through-2mm}
...
\subsection{Earth and Venus: Divergent Paths in a Growing-Planet Framework}\label{earth-and-venus-divergent-paths-in-a-growing-planet-framework}
...
\subsection{Water as the Signature of Planetary Maturity in 2MM}\label{water-as-the-signature-of-planetary-maturity-in-2mm}
...
\section{Momentum Flow in 2MM: Why Voids Flip the Sign}\label{momentum-flow-in-2mm-why-voids-flip-the-sign}

What follows is an application of the Two-Medium Model (2MM) to the
cosmological redshift problem. If you are new to the framework, the
top-level \href{https://github.com/ktonon/two-medium-model/blob/main/README.md}{README} provides an introduction to its
core ideas.
...
\subsection{1. Two Coupled Energy Reservoirs}\label{1-two-coupled-energy-reservoirs}
...
\subsection{2. Dense LCM Regions: Where the GCM Loses Energy}\label{2-dense-lcm-regions-where-the-gcm-loses-energy}
...
\subsection{3. The Problem With an Infinite Universe}\label{3-the-problem-with-an-infinite-universe}
...
\subsection{4. Voids: Where the Flux Runs Thin}\label{4-voids-where-the-flux-runs-thin}
...
\subsection{5. The Role of Photons: A Gentle, Forward-Coherent Transfer}\label{5-the-role-of-photons-a-gentle-forward-coherent-transfer}
...
\subsection{6. Voids as the Universe's Reset Mechanisms}\label{6-voids-as-the-universes-reset-mechanisms}
...
\subsection{7. A Future Predictive Handle}\label{7-a-future-predictive-handle}
...
\section{The Cosmic Microwave Background in an Infinite 2MM Universe}\label{the-cosmic-microwave-background-in-an-infinite-2mm-universe}

What follows is an application of the Two-Medium Model (2MM) to the
cosmic-background-radiation. Please read the
\href{https://github.com/ktonon/two-medium-model/blob/main/cosmological-redshift.md}{Cosmological Redshift} page first.

If you are new to the framework, the top-level
\href{https://github.com/ktonon/two-medium-model/blob/main/README.md}{README} provides an introduction to its core ideas.
...
\subsection{1. The Starting Point: Olbers' Paradox in an Infinite Universe}\label{1-the-starting-point-olbers-paradox-in-an-infinite-universe}
...
\subsection{2. Light Traveling Through Voids: A Slow Energy Drift}\label{2-light-traveling-through-voids-a-slow-energy-drift}
...
\subsection{3. Applying This Mechanism to an Infinite Universe}\label{3-applying-this-mechanism-to-an-infinite-universe}
...
\subsection{4. Where Does the Lost Energy Go?}\label{4-where-does-the-lost-energy-go}
...
\subsection{5. The CMB as the Equilibrium Temperature of Voids}\label{5-the-cmb-as-the-equilibrium-temperature-of-voids}
...
\subsection{6. A Universe Maintained by Voids}\label{6-a-universe-maintained-by-voids}
...
\subsection{7. The Clean Aesthetic of the 2MM Solution}\label{7-the-clean-aesthetic-of-the-2mm-solution}
