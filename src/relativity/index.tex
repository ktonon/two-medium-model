\section{Relativity}\label{5-relativity}
...
\subsection{5.1 Space-Time is Real}\label{51-space-time-is-real}
...
\subsection{5.2 Why Motion Through the LCM Causes Length Contraction}\label{52-why-motion-through-the-lcm-causes-length-contraction}
...
\subsection{5.3 Mutual Causation in the Two Media}\label{53-mutual-causation-in-the-two-media}
...
\subsection{5.4 Absolute Time, the GCM, and Faster-Than-Light Transmission}\label{54-absolute-time-the-gcm-and-faster-than-light-transmission}
...
\subsection{5.5 Oumuamua as an Illustration of GCM Shielding (Speculative)}\label{55-oumuamua-as-an-illustration-of-gcm-shielding-speculative}
