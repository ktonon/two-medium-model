...
\textbf{The Speed of Gravity: What the Experiments Say}, where he reviewed
timing delays, planetary motions, and signal propagation \cite{MetaResearchSpeedOfGravity1998}. His conclusion
was that gravity-like influences must propagate extraordinarily fast:

\begin{quote}
\textbf{Gravity must exceed 2 x 10\(^1\)\(^0\) c}, at least twenty billion times
the speed of light.
\end{quote}
...
\subsubsection{Implication for SETI}
