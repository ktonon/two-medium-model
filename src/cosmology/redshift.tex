\subsection{Momentum Flow in 2MM: Why Voids Flip the Sign}\label{momentum-flow-in-2mm-why-voids-flip-the-sign}
...
\subsubsection{Two Coupled Energy Reservoirs}\label{1-two-coupled-energy-reservoirs}
...
\subsubsection{Dense LCM Regions: Where the GCM Loses Energy}\label{2-dense-lcm-regions-where-the-gcm-loses-energy}
...
\subsubsection{The Problem With an Infinite Universe}\label{3-the-problem-with-an-infinite-universe}
...
\subsubsection{Voids: Where the Flux Runs Thin}\label{4-voids-where-the-flux-runs-thin}
...
\subsubsection{The Role of Photons: A Gentle, Forward-Coherent Transfer}\label{5-the-role-of-photons-a-gentle-forward-coherent-transfer}
...
\subsubsection{Voids as the Universe's Reset Mechanisms}\label{6-voids-as-the-universes-reset-mechanisms}
...
\subsubsection{A Future Predictive Handle}\label{7-a-future-predictive-handle}
