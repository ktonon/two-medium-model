\subsection{The Cosmic Microwave Background in an Infinite 2MM Universe}
...
\subsubsection{The Starting Point: Olbers' Paradox in an Infinite Universe}
...
\subsubsection{Light Traveling Through Voids: A Slow Energy Drift}
...
\subsubsection{Applying This Mechanism to an Infinite Universe}
...
\subsubsection{Where Does the Lost Energy Go?}
...
\subsubsection{The CMB as the Equilibrium Temperature of Voids}
...
\paragraph{Temperature (\textasciitilde2.7 K)}
...
\subsubsection{A Universe Maintained by Voids}
...
\subsubsection{The Clean Aesthetic of the 2MM Solution}
