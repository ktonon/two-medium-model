...
\subsection{4.1 Neutron Stars: Extreme Compression Without Matter Destruction}
...
\subsection{4.2 AGN Cores: Neutron Destruction and Charge-Conserving Recycling}
...
\subsection{4.3 Quasars as Newly Formed Matter in the Two-Medium Model}
...
\subsection{4.4 What about Cosmological Redshift and the CMB?}
