...
(matter "destruction"), we first have to address an observation
that is usually taken as strongly supporting a Big Bang cosmology.
That being, cosmological redshift.
...
in the thermodynamic sense, but in terms of
\textbf{how much momentum each medium carries relative to the equilibrium state of the environment.}
