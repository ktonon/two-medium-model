...
\subsubsection{Setting the Stage: The GCM Shapes the Terrain}
...
\subsubsection{The Photon Enters the Landscape}
...
\subsubsection{Capture Zones and Collapse}
...
\subsubsection{Why Collapse Looks Instantaneous}
